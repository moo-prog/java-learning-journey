# Quotes API
A lightweight, stateless RESTful API built with Spring Boot for retrieving and searching inspirational quotes.
...
1. **Clone the repository:**
   git clone https://github.com/mooprog/quotes-api.git
   cd quotes-api
